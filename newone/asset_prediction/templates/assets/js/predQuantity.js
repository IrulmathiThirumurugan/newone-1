...
//       row.innerHTML = `
// <td class="border-bottom-0"><h6 class="fw-semibold mb-0">${item["S.NO"].No}</h6></td>
// <td class="border-bottom-0"><div class="d-flex align-items-center gap-2"><p class="mb-0 fw-normal">${item["City"].City}</p></div></td>
// <td class="border-bottom-0"><h6 class="fw-semibold mb-1">${item["Part_number"].Part_number}</h6></td>
// <td class="border-bottom-0"><p class="mb-0 fw-normal">${item.Quantity}</p></td>
// <td class="border-bottom-0"><h6 class="fw-semibold mb-0 fs-4">${item["Cost per unit"]}</h6></td>
// <td class="border-bottom-0"><h6 class="fw-semibold mb-0 fs-4">${item["Total Amount"]}</h6></td>
//       `;
